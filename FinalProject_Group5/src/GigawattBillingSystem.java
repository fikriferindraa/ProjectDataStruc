...
public class GigawattBillingSystem extends JFrame {
	...
	public GigawattBillingSystem() {
		...
		label.setBounds(535, 25, 115, 147);
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				TotalUnit.setText(table.getValueAt(i, 7).toString());
				Total_Charge.setText(table.getValueAt(i, 8).toString());
				TotalBill.setText(table.getValueAt(i, 9).toString());
				} catch(Exception m) {
		...
		table.getColumnModel().getColumn(4).setPreferredWidth(19);
		table.getColumnModel().getColumn(6).setPreferredWidth(29);
		table.getColumnModel().getColumn(7).setPreferredWidth(26);
		table.getColumnModel().getColumn(8).setPreferredWidth(26);
